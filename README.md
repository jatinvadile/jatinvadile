...
## About me
Data Analyst with 5 years of experience delivering end-to-end BI
solutions across Logistics, FP&A, Procurement, and B2B operations.
Specialized in Power BI, SQL, Snowflake, Python ETL, and automation
workflows using Power Automate and FedEx API integration.
...
| [End-to-End Sales Analytics Platform | Microsoft Fabric | Power BI | ADLS]() | Microsoft Fabric · Power BI · ADLS · DAX · Lakehouse | Built a scalable end-to-end analytics platform using Medallion architecture with automated pipelines, star schema modeling, and real-time business dashboards |
